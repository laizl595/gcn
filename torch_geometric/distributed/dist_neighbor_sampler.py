...
class DistNeighborSampler:
    ...
    async def node_sample(
        ...
        seed_dict = None # to be removed?
        seed_time_dict = None # to be removed?
        ...
        if self.is_hetero:
            ...
            if isinstance(inputs, EdgeSamplerInput):
                ...
                # node_dict.out = {
                #     input_type[0]: inputs.row,
                #     input_type[-1]: inputs.col,
                # }
                ...
                #     batch_dict.out = {
                #         input_type[0]: src_batch_dict[input_type[0]],
                #         input_type[-1]: src_batch_dict[input_type[-1]],
                #     }
    ...
    async def edge_sample(
        ...
        # Homogeneus Neighborhood Sampling ########################################
            ...
            out = await sample_fn(NodeSamplerInput(inputs.input_id, seed,
                                seed_time, input_type=None))
